...
size_t len = 1024*1024, align = 0;  // unsigned long long
...
int main(int argc, char* argv[]) {
    ...
    switch (test) {
        ...
        default:
            ...
            printf("-a alloctest -m maptest -s sharetest -c ionmemtest \n -l len(alloc size, default 1024x1024) -g align(default-0) \n-p (MAP_PRIVATE|MAP_SHARED) -z (PROT_NONE|PROT_READ|PROT_WRITE|PROT_EXECM) \n -f alloc_flags -h heap_mask\n");
    }
    return 0;
}
